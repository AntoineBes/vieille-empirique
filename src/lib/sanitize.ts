...
const INSTITUTIONS: Institution[] = [
  ...
  "MINISTERE_ECONOMIE", "MINISTERE_TRAVAIL", "EUROSTAT", "AFT", "HCFP",
  "ASSEMBLEE_NATIONALE", "SENAT", "DREES", "DGFIP", "AUTRE",
];
const TYPES: TypeDocument[] = [
  ...
  "COMPARAISON_INTERNATIONALE", "DOSSIER_LEGISLATIF", "SCRUTIN", "AVIS", "AUTRE",
];
